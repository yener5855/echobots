...
<:arrow:1269532655586644009> BERO-HOST.de is sponsoring them with some free / cheaper Hosting Methods,
<:arrow:1269532655586644009> Thanks to them, we are able to host our Website, Bots and GAME SERVERS
<:arrow:1269532655586644009> Our suggestion is, if you want to host Bots / Games / Websites, then go to [BERO-HOST.de](http://bero-host.de/?utm_source=bot&utm_medium=cpc&utm_id=yener)
...
[**__SPONSOR LINK!__**](https://yener5855.is-local.org//img/paysafecard.png)
`)
		...
		let embed2 = new MessageEmbed()
			...
			.setDescription(`
<:arrow:1269532655586644009> Bittmax is providing us, like BERO-HOST with free Discord Bot-Hosting technologies

<:arrow:1269532655586644009> If you use the code: **\`x10\`** their, then you'll get at least 5% off everything!

<:arrow:1269532655586644009> Check out their [Website](https://bittmax.de) and their [Discord](https://discord.gg/GgjJZCyYKD) to get your own Bot too!`);
