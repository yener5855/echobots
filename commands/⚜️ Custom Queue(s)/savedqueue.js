  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `addcurrenttrack`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:1269542611408916521> Added ${track.title} onto the Queue \`${Name}\``.substring(0, 256))
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(`<a:yes:1269542611408916521> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substring(0, 256))
      ...
      case `mix`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:1269542611408916521> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substring(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:1269542611408916521> Removed ${counter} Tracks from the Queue \`${Name}\``.substring(0, 256))
