        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antidiscord.enabled`) ? "1269533999014084683" : "1269542611408916521"}`
          },
          {
            value: "Settings",
