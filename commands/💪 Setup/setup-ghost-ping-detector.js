    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Ghost-Ping-Detector Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'https://discord.gg/Xrd2D52pRF')
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<a:yes:1269542611408916521> I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(es.color)
