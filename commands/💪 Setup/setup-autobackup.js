...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:no:1269533999014084683> **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:no:1269533999014084683> **You need to be the Owner of this Server!**`)
      }
        ...
        let menuoptions = [
          {
            ...
            emoji: !client.settings.get(message.guild.id, "autobackup") ? "1269542611408916521" : "1269533999014084683"
          },
          {
            value: "Cancel",
