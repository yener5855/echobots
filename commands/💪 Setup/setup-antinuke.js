  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/Xrd2D52pRF')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<a:yes:1269542611408916521> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/Xrd2D52pRF')
              ...
              menuoptions = [
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "1269533999014084683": "1269542611408916521"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "1269533999014084683": "1269542611408916521"
                },
                {
                ...
                if(String(index) == "0"){
                   ...
                   */
                    ...
                    async function first_layer(){
                      menuoptions = [
                        {
                          ...
                          emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "1269533999014084683": "1269542611408916521"
                        },
                        {
                          value: "Remove Roles / Day",
                          description: `Amount of Actions / Day to remove the Roles`,
                          emoji: "1269541819805601863"
                        },
                        {
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/Xrd2D52pRF')
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<:no:1269533999014084683> You already selected something, this Selection is now disabled!`, ephemeral: true})
            ...
            return menu?.reply({content: "<a:yes:1269542611408916521> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
