    ...
    try {
      client.settings.ensure(message.guild.id, {
        boost: {
          ...
          message: "",
          log: false,
          stopBoost: "<a:Server_Boosts:1269533935860318281> {member} **stopped Boosting us..** <:Cat_Sad:867722685949804565>",
          startBoost: "<a:Server_Boosts:1269533935860318281> {member} **has boosted us!** <a:Light_Saber_Dancce:867721861462229013>",
          againBoost: "<a:Server_Boosts:1269533935860318281> {member} **has boosted us again!** <:Tada_WON:867724032207224833>",
        }
      })
      ...
      async function first_layer() {
        let menuoptions = [
          ...
          },
          {
            ...
            emoji: "a:Server_Boosts:1269533935860318281"
          },
          {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor({ name: "Boost-Log", url: "https://discord.gg/Xrd2D52pRF", iconURL: "https://cdn.discordapp.com/emojis/833402717950836806.gif?size=128&quality=lossless" })
          //.setAuthor('Boost-Log', 'https://cdn.discordapp.com/emojis/833402717950836806.gif?size=128&quality=lossless', 'https://discord.gg/Xrd2D52pRF')
