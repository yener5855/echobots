  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer() {
        ...
        //define the embed
        let MenuEmbed = new MessageEmbed().setColor(es.color).setAuthor('Suggestion System', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/light-bulb_1f4a1.png', 'https://discord.gg/Xrd2D52pRF').setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
        //send the menu msg
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:yes:1269542611408916521> Accepted Idea! Expect this soon.`,
          denymsg: `<:no:1269533999014084683> Thank you for the feedback, but we are not interested in this idea at this time.`,
          ...
          approveemoji: `1269542611408916521`,
          denyemoji: `1269533999014084683`,
        }
    });
      */
