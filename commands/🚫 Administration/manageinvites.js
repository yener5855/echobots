    ...
    try {
      ...
      let menuoptions = [
        ...
        },
        {
          ...
          emoji: "1269533999014084683" //optional
        },
        {
          value: "Remove Fakes",
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/Xrd2D52pRF")
          ...
          message.reply({embeds : [new MessageEmbed()
            .setAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://discord.gg/Xrd2D52pRF")
