...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let button_verify = new MessageButton().setStyle('SUCCESS').setCustomId('deleterole_verify').setLabel("Verify this Step").setEmoji("1269542611408916521")
      ...
      collector.on('end', collected => {
          if (!edited) {
              ...
              msg.edit({
                  content: `<@${message.author.id}>`,
                  embeds: [endedembed],
                  components: [new MessageActionRow().addComponents(button_verify.setDisabled(true).setLabel("FAILED TO VERIFY").setEmoji("1269533999014084683").setStyle('DANGER'))]
              }).catch((e) => {
                  console.log(String(e).grey)
              });
          }
