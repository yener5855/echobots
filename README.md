...
[**Invite the Public Version of this Bot**](https://yener.yener.dev) so you don't need to host it by yourself or [join my Discord server](https://discord.gg/dcdev) to get a custom Bot hosted for you!


# Important notes and thank ❤️
First of all, thanks for using this Source Code, it was and is a ton of work to create and maintain it!
That's why I'm asking everyone to [**donate a little bit of money**](https://donate.yener.dev) or if that's not possible, then join my [Discord Server](https://discord.gg/dcdev)!

  **NOTE:** It is suggested to use the [Sharded (&Clustered) version](https://github.com/yener5855/Multipurpose-discord-bot/tree/sharded_with_mongo), if you plan on using it for a VERIFIED BOT (on more then 2000 Servers!)
...
<details>
  ...
  * A VPS would be advised, so you don't need to keep your PC/laptop/RasPi 24/7 online! [Click here for a debian setup](https://github.com/yener5855/Debian-Cheat-Sheet-Setup/wiki/).
  * Check out my recommended Host: [BERO-HOST](https://bero.yener.dev) and use code `yener` for cheap OP VPS (kvm)
...
<details>
  ...
  **NOTE:** It is suggested to use the [Sharded (&Clustered) version](https://github.com/yener5855/Multipurpose-discord-bot/tree/sharded_with_mongo), if you plan on using it for a VERIFIED BOT (on more then 2000 Servers!)
  ...
  1. Download the [Source Code](https://github.com/yener5855/Multipurpose-discord-bot/releases/latest)
     * Either by: `git clone https://github.com/yener5855/Multipurpose-discord-bot`
...
<details>
  ...
  *There are many public ones out there for example lava.link*
  ...
  1. Make sure `Java 11` is installed on your system!
     * [Click here for a Download for **Linux**](https://github.com/yener5855/Debian-Cheat-Sheet-Setup/wiki/3.5.2-java-11)
     * [Click here for a Download for **Windows**](https://downloads.yener.eu/windows/java/jdk-11.0.11.exe) ​
...
<details>
  ...
  **NOTE:** *You can do the exact same configuration inside of the `example.env` file, just make sure to rename it to `.env` or use environment variables!*
   ...
   5. Now start the bot by opening a cmd line in that folder and typing: `node index.js` or `npm start`
     * If you don't want to keep the terminal open or if you're on linux, check out [pm2 (and my tutorial)](https://github.com/yener5855/Debian-Cheat-Sheet-Setup/wiki/4-pm2-tutorial) and type: `pm2 start --name Bot_Name index.js`
...
## SUPPORT ME AND yener DEVELOPMENT

> You can always support me by inviting one of my **Discord Bots**

[![2021's best Music Bot | Lava Music](https://cdn.discordapp.com/attachments/748533465972080670/817088638780440579/test3.png)](https://lava.yener.dev)
[![Musicium Music Bot](https://cdn.discordapp.com/attachments/742446682381221938/770055673965707264/test1.png)](https://musicium.musicium.dev)
[![yener Multi Bot](https://cdn.discordapp.com/attachments/742446682381221938/770056826724679680/test1.png)](https://yener.yener.dev)

# Credits

> If you consider using this Bot, make sure to credit me!
> Example: `Bot Coded by [yener5855](https://discord.gg/dcdev) but modified by [modifier/your Name](https://discord.gg/)`
...
> Please consider, that [**yener5855**](https://github.com/yener5855) is the main Developer of this Bot, everyone else helped just once or sometimes more often.
