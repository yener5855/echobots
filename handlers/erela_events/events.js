      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<:no:1269533999014084683> Nothing Playing yet", ephemeral: true})
...
var embed = new MessageEmbed().setColor(ee.color)
  embed.setAuthor(`${track.title}`, "https://images-ext-1.discordapp.net/external/DkPCBVBHBDJC8xHHCF2G7-rJXnTwj_qs78udThL8Cy0/%3Fv%3D1/https/cdn.discordapp.com/emojis/a:Playing_Audio:1269512711918850131.gif", track.uri)
