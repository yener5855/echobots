...
console.log("Welcome to SERVICE HANDLER /--/ By https://yener5855.is-local.org/ /--/ Discord: yener5855".yellow);
      ...
      member.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.color)
            .setThumbnail(member.guild.iconURL({dynamic: true}))
            .setAuthor(`Giveaway Entry Confirmed`, `https://cdn.discordapp.com/emojis/1269542611408916521.gif?size=128`)
      ...
      member.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.wrongcolor)
            .setThumbnail(member.guild.iconURL({dynamic: true}))
            .setAuthor(`Giveaway Left!`, `https://cdn.discordapp.com/emojis/1269542611408916521.gif?size=128`)
      ...
      winner.send({
        ...
        embeds: [
          new MessageEmbed()
            ...
            .setAuthor(`Giveaway Won!`, `https://cdn.discordapp.com/emojis/1269542611408916521.gif?size=128`)
